...
const String BASEURL = "https://manager.atmavishwasect.org/api/";
const String BASE_URL_DOMAIN = "manager.atmavishwasect.org";
...
//
MaterialColor primarySwatch = MaterialColor(0xFF0057B8, <int, Color>{
  50: Color(0xFF0057B8),
  100: Color(0xFF0057B8),
  200: Color(0xFF0057B8),
  300: Color(0xFF0057B8),
  400: Color(0xFF0057B8),
  500: Color(0xFF0057B8),
  600: Color(0xFF0057B8),
  700: Color(0xFF0057B8),
  800: Color(0xFF0057B8),
  900: Color(0xFF0057B8),
});

const Color kPrimaryColor = Color(0xFF0057B8);
...
const Color mediumBlueColor = Color(0xFFECF5FF);
...
const Color redColor = Color(0xFFE95E5E);
